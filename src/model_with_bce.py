...
from fcpe.pcmer import PCmer

# from fcpe.pcmer_siren import PCmer as PCmerS
# from fcpe.pcmer_full import PCmer as PCmerF
# from fcpe.pcmer_siren_full import PCmer as PCmerFS
from fcpe.nvSTFT import STFT
...
class TransformerF0BCE(nn.Module):
    def __init__(
        ...
        self.residual_dropout = (
            residual_dropout if (residual_dropout is not None) else 0.1
        )
        self.attention_dropout = (
            attention_dropout if (attention_dropout is not None) else 0.1
        )
