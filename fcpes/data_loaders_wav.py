...
class F0Dataset(Dataset):
    ...
    def get_data(self, name_ext, data_buffer):
        with torch.no_grad():
            ...
            if keyshift != 0:
                audio = torchaudio.transforms.PitchShift(self.sample_rate, keyshift)(audio)
            ...
            audio = audio[int(idx_from * self.sample_rate): int((idx_from + waveform_sec) * self.sample_rate)]
            ...
            output = (audio, f0_frames, name, name_ext)
            return output
