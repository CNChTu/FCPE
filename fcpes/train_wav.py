...
from fcpes.saver import utils
from fcpes.data_loaders_wav import get_data_loaders
from fcpes.model_with_bce import TransformerF0BCE
from fcpes.solver_wav import train
...
if __name__ == '__main__':
    ...
    if args.model.type == 'TransformerF0BCE':
        model = TransformerF0BCE(
            ...
            windows_size=args.data.win_size,
